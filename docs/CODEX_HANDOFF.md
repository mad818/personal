...
- FREE-LOCAL-PHONE-ACCEPTANCE — Desktop LAN runtime proof, the phone checklist, the protected receipt lane, assistant receipt bridge, and live receipt status are in place. The existing Free Local Readiness panel silently posts sanitized local receipts...
