...
// Shows the static project doctrine injected into agent prompts.
// This is intentionally labeled as doctrine until runtime detection is implemented.
"use client";
...
export function ProjectStackCard() {
  ...
  // Safe: synchronous getter — returns the current local doctrine block.
        ...
        <div className="mt-3 space-y-3">
          ...
          <div className="space-y-2">
            <div className="flex flex-wrap gap-2">
              ...
              <ShellBadge tone="accent">Static doctrine</ShellBadge>
            </div>
            <p className="font-mono text-[9px] text-[var(--text3)]">
              This card reflects the current hardcoded Nexus project doctrine block,
