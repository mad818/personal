...
`.trim();
  ...
  return (
    ...
    >
      ...
      >
        Scores your role 0–10 on AI displacement risk. Average across 342 BLS
        occupations: 5.3/10.
      </div>
      ...
      <div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
          {displayed.map((b) => (
            ...
            >
              <span
                style={{ fontSize: "11.5px", color: "var(--text)", flex: 1 }}
              >
                {b.job}
              </span>
              <span
