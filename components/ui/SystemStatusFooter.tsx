...
export default function SystemStatusFooter() {
  ...
  const officeOperationalMode = useStore(
    (s) => s.settings.officeOperationalMode ?? "normal",
  );
  ...
  return (
    <div
      style={{
        ...
        backgroundImage:
          "linear-gradient(rgba(10,7,8,0.92), rgba(10,7,8,0.92)), linear-gradient(90deg, rgba(196,72,90,0.35), rgba(212,149,106,0.2), transparent)",
