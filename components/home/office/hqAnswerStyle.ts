...
const REPO_WORK_RE =
  /\b(?:repo|repository|codebase|file|files|component|hook|api route|patch|refactor|implement|debug|fix|build|typescript|next\.?js|read the code|search the repo|github|dependency|dependencies|reference repo|reference library|competitor repo|open source|oss|assess repo|analy(?:s|z)e repo)\b/i;
