...
export type VehicleTelemetrySourceMode =
  | "simulation"
  | "replay"
  | "live_bridge";
export type VehicleAuthorityClass =
  | "read_only"
  | "advisory"
  | "command_capable";
...
export type VehicleFlightMode =
  | "STABILIZE"
  | "LOITER"
  | "AUTO"
  | "RTL"
  | "LAND";
export type VehicleMissionPhase =
  | "idle"
  | "enroute"
  | "holding"
  | "rtl"
