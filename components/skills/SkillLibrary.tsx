...
import { observeSkill, routeTask, configureSkillCycle } from "@/lib/skillCycle";
...
function SkillCard({
  ...
  return (
    <motion.div
      ...
      whileHover={{
        borderColor: highlighted ? "var(--accent)" : "var(--border2)",
      }}
      ...
      >
        <motion.div
          ...
          style={{
            height: "100%",
            borderRadius: "2px",
            background: getSkillBarGradient(avgLevel),
          }}
        />
      </div>
...
export default function SkillLibrary({
  ...
  return (
    <div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <span
            style={{
              ...
              fontWeight: 900,
              fontFamily: "monospace",
              color: avgSuccessRate >= 80 ? "var(--fhi)" : "var(--gold)",
            }}
          >
            {avgSuccessRate}%
          </span>
      ...
      <AnimatePresence>
        {activeToast && (
          <XPToast key={activeToast.id} event={activeToast} onDone={() => {}} />
        )}
      </AnimatePresence>
    </div>
  );
