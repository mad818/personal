...
const VIEWS: { id: View; label: string; tip: string }[] = [
  {
    id: "osint",
    label: "🔍 OSINT Lookup",
    tip: "Domain · IP · Email · Username · Hash",
  },
  {
    id: "pdns",
    label: "📡 Passive DNS",
    tip: "Historical records · reverse IP lookup",
  },
  ...
  return (
    <div style={{ padding: "18px 16px", maxWidth: "1300px", margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: "14px" }}>
        ...
        >
          Privacy-first OSINT suite. Free by default — no data leaves your
          browser except lookup targets you enter.
        </p>
      </div>
