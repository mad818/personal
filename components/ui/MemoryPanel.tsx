...
async function listAllMemories(): Promise<Memory[]> {
  ...
  const results = await Promise.all(types.map(t => m.recallByType?.(t, 200) ?? Promise.resolve([])))
    ...
    <div style={{
      ...
      >
        ...
        <span style={{
          ...
          color, letterSpacing: '1px', flexShrink: 0,
        }}>
        ...
        {/* Content preview */}
        <span style={{
          flex: 1, fontSize: '11px', color: '#8892b0',
        ...
        <div style={{
          ...
          background: '#1A2040', borderRadius: '2px', overflow: 'hidden', flexShrink: 0,
        }}>
          <div style={{
            height: '100%',
        ...
        <span style={{
          ...
          color: '#304060', flexShrink: 0, letterSpacing: '0.5px',
        }}>
      ...
      {open && (
        <div style={{
          ...
          <p style={{
            margin: '0 0 8px', fontSize: '12px', color: '#ccd6f6',
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4px', marginBottom: '8px' }}>
              {mem.tags.map(tag => (
                <span key={tag} style={{
                  fontSize: '8px', fontFamily: "'VT323', monospace",
                  padding: '1px 5px', borderRadius: '3px',
                  background: '#0f1825', border: '1px solid #1A2040',
                  color: '#4a5568', letterSpacing: '0.5px',
                }}>
                  #{tag}
                </span>
              ))}
          ...
          <div style={{
            ...
            fontSize: '8px', fontFamily: "'VT323', monospace", color: '#304060',
          }}>
            <span>
              ACCESSED {mem.accessCount}× · SCORE {Math.round(mem.relevanceScore * 100)}%
              {mem.source && ` · SRC: ${mem.source.toUpperCase()}`}
            </span>
            <button
              onClick={(e) => { e.stopPropagation(); onDelete(mem.id) }}
              style={{
...
export default function MemoryPanel({ open, onClose }: MemoryPanelProps) {
  ...
  const load = useCallback(async () => {
    setLoading(true)
    try {
      const [mems, s] = await Promise.all([listAllMemories(), getMemoryStats()])
      setMemories(mems)
      setStats(s)
    } catch { /* silent */ }
  ...
  const filtered = memories.filter(m => {
    ...
    const matchesQuery = !query || m.content.toLowerCase().includes(query.toLowerCase())
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{
            ...
            color: '#00FF66', letterSpacing: '2px', flex: 1,
          }}>
            AGENT MEMORY CORE
          </span>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '4px', color: '#6875a0',
              cursor: 'pointer', padding: '2px 7px', fontSize: '10px',
            }}
          >
            ✕
          </button>
        ...
        <div style={{
          ...
          borderBottom: '1px solid #1A2040', flexShrink: 0,
        }}>
          {(['all', 'fact', 'preference', 'episode', 'skill_note'] as const).map(t => {
            ...
            return (
              ...
              >
                ...
                <br />
                <span style={{ fontSize: '9px', color: active ? color : '#1A2040' }}>{count}</span>
              </button>
            )
          })}
        </div>
        ...
        <div style={{ padding: '8px 12px', flexShrink: 0 }}>
          <input
            ...
            style={{
              ...
              border: '1px solid #1A2040', borderRadius: '6px',
              padding: '6px 10px', fontSize: '12px', color: '#ccd6f6',
        ...
        <div style={{
          ...
          {loading ? (
            <div style={{
              ...
              color: '#304060', letterSpacing: '2px',
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '5px',
              fontSize: '8px', fontFamily: "'VT323', monospace",
              color: '#00DDFF', cursor: 'pointer', letterSpacing: '1px',
            }}
          >
            ↺ REFRESH
          </button>
          <button
            ...
            style={{
              ...
              borderRadius: '5px',
              fontSize: '8px', fontFamily: "'VT323', monospace",
              color: '#f59e0b', cursor: 'pointer', letterSpacing: '1px',
            }}
          >
            ✂ PRUNE OLD
          </button>
          <button
            ...
            style={{
              ...
              borderRadius: '5px',
              fontSize: '8px', fontFamily: "'VT323', monospace",
              color: '#00FF66', cursor: 'pointer', letterSpacing: '1px',
            }}
          >
            ↓ EXPORT
          </button>
