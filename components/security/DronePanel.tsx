...
export default function DronePanel() {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      setTelem((prev) => ({
        ...
        pitch: Math.max(
          -15,
          Math.min(15, prev.pitch + (Math.random() - 0.5) * 0.3),
        ),
        roll: Math.max(
          -15,
          Math.min(15, prev.roll + (Math.random() - 0.5) * 0.2),
        ),
  ...
  const batteryColor =
    telem.battery > 50 ? "#10b981" : telem.battery > 20 ? "#f59e0b" : "#ef4444";
      ...
      >
        ...
        >
          ...
          <span
            style={{
              ...
              padding: "2px 7px",
              borderRadius: "4px",
              background: `${MODE_COLORS[telem.mode]}22`,
              color: MODE_COLORS[telem.mode],
            }}
          >
            {telem.mode}
          </span>
        ...
        >
          {[
            ...
            {
              label: "Altitude",
              value: `${telem.altitude.toFixed(1)} m`,
              color: "var(--text)",
            },
            {
              label: "Speed",
              value: `${telem.speed.toFixed(1)} m/s`,
              color: "var(--text)",
            },
            {
              label: "Pitch",
              value: `${telem.pitch.toFixed(1)}°`,
              color: "var(--accent2)",
            },
            {
              label: "Roll",
              value: `${telem.roll.toFixed(1)}°`,
              color: "var(--accent2)",
            },
            {
              label: "Yaw",
              value: `${Math.round(telem.yaw)}°`,
              color: "var(--accent2)",
            },
          ].map((m) => (
            <div
        ...
        >
          ...
          <span
            style={{
              ...
              fontWeight: 700,
              fontFamily: "monospace",
              color: GPS_FIX_COLORS[telem.gpsFix],
            }}
          >
          ...
          {(["Forward", "Downward"] as CamFeed[]).map((f) => (
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                border: "none",
                background: camFeed === f ? "var(--accent)" : "var(--surf)",
                color: camFeed === f ? "#fff" : "var(--text2)",
              }}
            >
              {f} Cam
            </button>
        ...
        >
          <button
            ...
            style={{
              ...
              border: "none",
              background: launched ? "var(--surf)" : "var(--accent)",
              color: launched ? "var(--text3)" : "#fff",
          ...
          <button
            ...
            style={{
              ...
              cursor: "pointer",
              border: "none",
              background: telem.mode === "RTH" ? "#10b981" : "var(--surf2)",
              color: telem.mode === "RTH" ? "#fff" : "var(--text2)",
            }}
          >
            🏠 RTH
          </button>
            ...
            style={{
              ...
              background:
                telem.mode === "Hover"
                  ? "rgba(196,72,90,0.25)"
                  : "var(--surf2)",
              color: telem.mode === "Hover" ? "var(--accent)" : "var(--text2)",
            }}
          >
            ✋ HOVER
          </button>
