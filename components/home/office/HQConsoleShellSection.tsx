    ...
    <>
      <div
        style={{
          padding: "6px 16px",
          background:
            `linear-gradient(180deg, rgba(24,15,18,0.94), rgba(14,9,11,0.98)), radial-gradient(circle at 14% 24%, ${telemetryCue.accentColor}14, transparent 30%)`,
          borderBottom: `1px solid rgba(212,149,106,${0.14 + telemetryCue.alertWash * 0.16})`,
          display: "flex",
          alignItems: "center",
          gap: "8px",
          flexShrink: 0,
        ...
        {!compactSplitControls ? (
          <button
            ...
            style={{
              borderRadius: 999,
              border: `1px solid ${
                splitDragLocked ? "rgba(132,217,141,.46)" : "rgba(212,149,106,0.18)"
              }`,
