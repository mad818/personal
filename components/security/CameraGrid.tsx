    ...
    return (
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(135deg, rgba(59,130,246,0.06) 0%, rgba(245,158,11,0.06) 50%, rgba(239,68,68,0.08) 100%)",
          borderRadius: "var(--r)",
          pointerEvents: "none",
        }}
      />
...
export default function CameraGrid() {
  ...
  const expandedCamera = expanded
    ? CAMERAS.find((c) => c.id === expanded)
    : null;
            ...
            <motion.div
              ...
              animate={{
                boxShadow: isFlashing
                  ? "0 0 0 2px #ef4444, 0 0 16px 4px rgba(239,68,68,0.4)"
            ...
            >
              ...
              >
                ...
                <span
                  style={{
                    fontSize: "9px",
                    color: isOnline ? "#10b981" : "var(--text3)",
                    fontWeight: 700,
                  }}
                >
                ...
                <span
                  style={{
                    ...
                    padding: "1px 6px",
                    borderRadius: "4px",
                    background: `${TYPE_COLORS[cam.type]}22`,
                ...
                {isConnected && isOnline ? (
                  ...
                  <>
                    ...
                    <span style={{ fontSize: "10px", color: "var(--text3)" }}>
                      {isOnline ? "Not Connected" : "Camera Offline"}
                    </span>
                  </>
                )}
              </div>
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    cursor: "pointer",
                    background: isConnected ? "var(--surf2)" : "var(--accent)",
                    color: isConnected ? "var(--text2)" : "#fff",
                  }}
                >
                ...
                <button
                  ...
                  style={{
                    fontSize: "10px",
                    fontWeight: 700,
                    background: isRec ? "rgba(239,68,68,0.15)" : "transparent",
                    border: "none",
                    cursor: "pointer",
                    padding: "2px 6px",
                    borderRadius: "4px",
                    color: isRec ? "#ef4444" : "var(--text3)",
                  }}
                >
                  {isRec ? "⏹" : "⏺"}
                </button>
                ...
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    toggleDetection(cam.id);
                  }}
                  title="Motion Detection"
                  style={{
                    fontSize: "9px",
                    fontWeight: 700,
                    background: isDet ? "rgba(196,72,90,0.15)" : "transparent",
                    border: "none",
                    cursor: "pointer",
                    padding: "2px 6px",
                    borderRadius: "4px",
                    color: isDet ? "var(--accent)" : "var(--text3)",
                  }}
                >
                  AI
                </button>
            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: "11px", color: "var(--text3)" }}>
                  RTSP Stream — Full Resolution 1920×1080
                </span>
              </div>
            </div>
          </motion.div>
