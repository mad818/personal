...
const ASSISTANT_WORKSPACES: AssistantWorkspaceEntry[] = [
  ...
  },
  {
    ...
    detail:
      "Prepared the governed market-review lane so thesis continuity, prior setups, and durable operator notes are ready first.",
  },
  {
    id: "alpha-scanner",
    route: "/alpha",
  ...
  },
  {
    ...
    label: "Open SECURITY doctrine",
    detail:
      "Prepared the doctrine lane so review and boundary framing are ready first.",
  },
  {
