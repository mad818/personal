...
const STAGES: Stage[] = [
  {
    ...
    prompt:
      "You are a startup advisor. The user wants to start a service business targeting $4K/month. Help them validate their idea with 3 specific, actionable steps they can take this week. Be concise and direct. No fluff.",
  },
  {
    key: "offer",
    label: "2 · Build Offer",
    ...
    prompt:
      "You are a service business coach. The user has validated demand and now needs to package their offer. Give them 3 specific steps to create a compelling, premium offer this week. Focus on positioning and pricing.",
  },
  {
    key: "outreach",
    label: "3 · Outreach",
    ...
    prompt:
      "You are a B2B sales coach. The user has an offer and needs to start outreach. Give them 3 concrete steps to get their first sales conversations this week. Include a short cold outreach template.",
  },
  {
    key: "close",
    label: "4 · Close",
    ...
    prompt:
      "You are a sales closer. The user is having discovery calls and needs to close deals. Give them 3 specific steps to close their first client this week. Include one objection-handling tip.",
  },
  {
    key: "deliver",
    ...
    prompt:
      "You are a service business operator. The user has a paying client and needs to deliver great work and scale to $4K/month. Give them 3 specific steps for this week to systemize delivery and get referrals.",
  },
];
...
export default function BusinessBuilder() {
  ...
  const progress = (() => {
    ...
    const done = stage.checks.filter(
      (_, i) => checks[`${stage.key}-${i}`],
    ).length;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          style={{ fontSize: "11px", color: "var(--text3)", fontWeight: 600 }}
        >
        ...
        >
          ...
          />
          <span
            style={{ fontSize: "10.5px", color: revenueColor, fontWeight: 700 }}
          >
      ...
      >
        {STAGES.map((s) => {
          const stageChecks = s.checks.filter(
            (_, i) => checks[`${s.key}-${i}`],
          ).length;
          ...
          return (
            <label
              ...
              style={{
                ...
                borderRadius: "7px",
                border: `1px solid ${checked ? "rgba(16,185,129,.25)" : "transparent"}`,
              }}
            >
              <input
                type="checkbox"
              ...
              <span
                style={{
                  fontSize: "12px",
                  color: checked ? "var(--fhi)" : "var(--text)",
