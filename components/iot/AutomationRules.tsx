...
const DEMO_RULES: AutoRule[] = [
  {
    id: "r1",
    name: "Night Watch",
    trigger: "Motion detected after 10PM",
    action: "Turn on floodlights + Record all cameras",
    enabled: true,
    icon: "🌙",
    color: "#818cf8",
  },
  {
    id: "r2",
    name: "Thermal Alert",
    trigger: "Temperature sensor > 40°C",
    action: "Send push notification + Activate cooling",
    enabled: true,
    icon: "🔥",
    color: "#f59e0b",
  },
  {
    ...
    trigger: "Door sensor triggered + No authorized BLE device nearby",
    action: "Sound alarm + Record all cameras",
    enabled: true,
    icon: "🚨",
    color: "#ef4444",
  },
  ...
  },
  {
    id: "r5",
    name: "Drone Patrol",
    trigger: "Perimeter breach at night (after 10PM)",
    action: "Launch UAV-1 patrol + Notify security team",
    enabled: true,
    icon: "🚁",
    color: "var(--accent)",
  },
  ...
  return (
    <div>
      ...
      >
        ...
        >
          Automation Rules — {rules.filter((r) => r.enabled).length}/
          {rules.length} Active
        </div>
        <button
                ...
                >
                  <span
                    style={{
                      ...
                      padding: "1px 5px",
                      borderRadius: "3px",
                      background: "rgba(196,72,90,0.15)",
                      color: "var(--accent)",
                      whiteSpace: "nowrap",
                    }}
                  >
