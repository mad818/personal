...
// ── AgentOffice.tsx ───────────────────────────────────────────────────────────
// Homefront HQ — pixel art multi-agent command centre.
...
const P: Record<string, string> = {
  ...
  R: "#c0392b",
  w: "#7ba7d4",
  W: "#4a6fa5", // blue-grey coat — visible on dark bg
  l: "#87ceeb",
  // Crab
  c: "#d04020",
  C: "#8a2010",
...
function CrabMascot({ emotion }: { emotion: Emotion }) {
  ...
  return (
    ...
    >
      ...
      >
        <Sprite
          rows={CRAB[blink && emotion === "thinking" ? "idle" : emotion]}
          scale={1.3}
        />
      </div>
      <span
  ...
  return (
    <div
      style={{
        ...
        animation:
          active || dispatched
            ? "agentWork .55s ease-in-out infinite alternate"
            : routing
              ? "agentLean .4s ease-in-out infinite alternate"
              : "none",
      }}
    >
      ...
      <div
        style={{
          ...
          boxShadow: isLive
            ? `inset 0 0 18px ${cfg.color}1a, 0 -2px 10px ${cfg.color}18`
            : "none",
          width: "100%",
        }}
      >
        ...
        <svg width="54" height="38" style={{ display: "block", flexShrink: 0 }}>
          ...
          {isLive && (
            <circle cx="6" cy="5" r="2" fill={cfg.color} opacity="0.9" />
          )}
          {/* Monitor stand neck */}
        ...
        <div
          style={{
            animation: dispatched
              ? "agentWalk .3s ease-in-out infinite alternate"
              : active
                ? "agentWalk .6s ease-in-out infinite alternate"
                : "none",
            marginTop: "1px",
          }}
        >
      ...
      <div
        style={{
          background: isLive
            ? `color-mix(in srgb, ${cfg.color} 18%, #0D1220)`
            : "#0D1220",
      ...
      >
        <div
          style={{
            ...
            fontWeight: 900,
            letterSpacing: ".08em",
            color: isLive ? cfg.color : "var(--text3)",
          }}
        >
          {cfg.name}
        </div>
...
export default function AgentOffice() {
  ...
  const [dispatchBar, setDispatchBar] = useState<{
    from: AgentId;
    to: AgentId;
  } | null>(null);
  ...
  const send = useCallback(async () => {
    ...
    const enrichedPrompt = buildAgentPrompt(
      target,
      buildSystemPrompt(currentSettings),
    );
      ...
      >
        ...
        <div
          style={{
            ...
            height: "4px",
            background:
              "linear-gradient(to right, transparent 5%, #00DDFF44 20%, #00DDFF99 50%, #00DDFF44 80%, transparent 95%)",
        ...
        <div
          style={{
            ...
            height: "100px",
            background:
              "radial-gradient(ellipse at 50% 0%, #00DDFF12 0%, transparent 70%)",
            pointerEvents: "none",
            zIndex: 1,
          }}
        />
        ...
        <div
          style={{
            ...
            height: "1px",
            background:
              "linear-gradient(to right, transparent, #1A2040 15%, #1A2040 85%, transparent)",
            opacity: 0.5,
            zIndex: 1,
          }}
        />
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          ...
          <div
            style={{
              height: "12px",
              background:
                "linear-gradient(180deg, #3A2A1A 0%, #2a1e10 50%, #1e1508 100%)",
        ...
        {/* System monitor */}
        <div
          style={{ position: "relative", zIndex: 2, padding: "8px 24px 10px" }}
        >
        ...
        {!messages.length && (
          ...
          >
            ...
            <div style={{ fontSize: "11px", lineHeight: 1.7 }}>
              ...
              . He routes your request to the right specialist.
              <br />
              Code → <span style={{ color: "#7c3aed" }}>ORBIT</span> · Research
              → <span style={{ color: "#00FF66" }}>NOVA</span> · Security →{" "}
              <span style={{ color: "#14b8a6" }}>CIPHER</span> · Markets →{" "}
              <span style={{ color: "#f59e0b" }}>FLUX</span>
            </div>
          </div>
        )}
                  ...
                  <div
                    ...
                    style={{
                      ...
                      background: activeAgent
                        ...
                        : "var(--text3)",
                      animation: `dotPulse .9s ease-in-out ${i * 0.18}s infinite`,
                    }}
                  />
                ))}
              </div>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              borderRadius: "10px",
              background:
                input.trim() && !activeAgent ? "var(--accent)" : "var(--surf3)",
              border: "none",
