...
assertIncludes(hqTerminal, "IntelOnlyAgentGate", "HQ intel-only gate");
assertIncludes(aiRoute, "normalizeOllamaEndpoint", "ai route ollama SSRF guard");
assertIncludes(aiRoute, "resolveProviderChainForTask", "ai route local chain");
