...
export const ROUTE_POLICIES: RoutePolicy[] = [
  ...
  {
    prefix: "/api/metrics/runtime-experiments/run",
  ...
  {
    prefix: "/api/metrics/runtime-eval/forecast/run",
    routeClass: "local_only",
    public: false,
  },
  {
    prefix: "/api/metrics/runtime-eval/forecast",
    routeClass: "local_only",
    public: false,
  },
  {
    prefix: "/api/metrics/runtime-eval/scheduler-efficiency/run",
    routeClass: "local_only",
    public: false,
  },
  {
    prefix: "/api/metrics/runtime-eval/scheduler-efficiency/source",
    routeClass: "local_only",
    public: false,
  },
  {
    prefix: "/api/metrics/runtime-eval/scheduler-efficiency",
    routeClass: "local_only",
    public: false,
  },
  {
    prefix: "/api/metrics/runtime-eval/run",
    routeClass: "local_only",
    public: false,
  },
  {
    prefix: "/api/metrics/runtime-eval",
    routeClass: "local_only",
    public: false,
  },
  ...
  {
    prefix: "/api/phone-acceptance/receipt",
    routeClass: "local_only",
    public: false,
  },
  {
    prefix: "/api/privacy-shield/preview",
    routeClass: "local_only",
    public: false,
  },
  ...
  { prefix: "/api/feynman/papers", routeClass: "local_only", public: false },
  ...
  {
    prefix: "/api/network-health/check",
    routeClass: "local_only",
    public: false,
  },
  { prefix: "/api/espectre", routeClass: "local_only", public: false },
  {
    prefix: "/api/masterdnsvpn/readiness",
    routeClass: "local_only",
    public: false,
  },
  {
    prefix: "/api/windows-optimization-advisor",
    routeClass: "local_only",
    public: false,
  },
  ...
  { prefix: "/api/mcp/gateway", routeClass: "local_only", public: false },
  { prefix: "/api/ideas/intake", routeClass: "local_only", public: false },
  {
    prefix: "/api/local-acceleration",
    routeClass: "local_only",
    public: false,
  },
  {
    prefix: "/api/assistant/retrieve",
    routeClass: "connector_opt_in",
    public: false,
  },
  ...
  {
    prefix: "/api/subscription-escape",
    routeClass: "local_only",
    public: false,
  },
  {
    prefix: "/api/security/scenarios",
    routeClass: "local_only",
    public: false,
  },
  ...
  { prefix: "/api/geocode", routeClass: "connector_opt_in", public: false },
  { prefix: "/api/papers", routeClass: "connector_opt_in", public: false },
  ...
  {
    prefix: "/api/recon/lookup",
    routeClass: "connector_opt_in",
    public: false,
  },
  {
    prefix: "/api/recon/passive-dns",
    routeClass: "connector_opt_in",
    public: false,
  },
  {
    prefix: "/api/recon/tor-check",
    routeClass: "connector_opt_in",
    public: false,
  },
  ...
  {
    prefix: "/api/legal-compliance/drone",
    routeClass: "high_risk",
    public: false,
  },
  { prefix: "/api/vault-synthesis", routeClass: "high_risk", public: false },
  {
    prefix: "/api/ai/batches/[batchId]",
    routeClass: "high_risk",
    public: false,
  },
