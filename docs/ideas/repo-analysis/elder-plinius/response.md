## elder-plinius portfolio — Analysis complete

**What it is:** A mixed portfolio of AI, prompt-transparency, text-processing, red-team, and agent experiments.
**Stack:** TypeScript, JavaScript, Python, React, Vite, Convex, Streamlit, Gradio
