  ...
  hq: {
    ...
    boxMatrix: [
      entry(
        ...
        "merged",
        "mission-brief",
        "Merge control posture and mode emphasis into the main brief.",
      ),
      entry(
        "Posture",
        "merged",
        "mission-brief",
        "Fold runtime and threat posture into the brief instead of a separate stat card.",
      ),
      entry(
        "Mission codex",
        "merged",
        "mission-brief",
        "Keep objective, urgency, evidence, and next move in the same brief module.",
      ),
      entry(
        "Active fronts",
        "merged",
        "next-move",
        "Treat fronts as the strongest route choices, not a separate peer panel.",
      ),
      entry(
        "Command verbs",
        "merged",
        "next-move",
        "Keep verbs near the strongest continuation, not as another equal-weight card.",
      ),
      entry(
        "Operator shortcuts",
        "merged",
        "next-move",
        "Shortcuts become supporting execution hints inside the next-move lane.",
      ),
      entry(
        "Command choir",
        "merged",
        "runtime-continuity",
        "Agent readiness belongs with continuity and runtime posture.",
      ),
      entry(
        "Command systems",
        "merged",
        "runtime-continuity",
        "System actions become continuity support, not a separate top-level panel.",
      ),
      entry(
        "Sanction rail",
        "merged",
        "runtime-continuity",
        "Lesson queue, chronicle recap, and memory sit in the same continuity lane.",
      ),
      entry(
        "Command chronicle",
        "primary",
        "command-chronicle",
        "Keep the chronicle/composer as the main workspace.",
      ),
      entry(
        "Workflow commands",
        "demoted",
        "command-chronicle",
        "Replace the standing band with contextual composer help.",
      ),
      entry(
        "Evidence posture",
        "demoted",
        "command-chronicle",
        "Render only when evidence-sensitive answers require it.",
      ),
      entry(
        "Workspace prepared",
        "demoted",
        "command-chronicle",
        "Keep continuation compact and contextual inside the chronicle.",
      ),
    ],
  },
  command: {
    ...
    boxMatrix: [
      entry(
        ...
        "merged",
        "system-posture",
        "Present offline posture as one part of system readiness.",
      ),
      entry(
        "Network health",
        "merged",
        "system-posture",
        "Keep connectivity under the shared posture module.",
      ),
      entry(
        "Agent health",
        "merged",
        "system-posture",
        "Fold agent readiness into the same posture lens.",
      ),
      entry(
        "Runtime efficiency",
        "merged",
        "system-posture",
        "Keep runtime pressure and health together.",
      ),
      entry(
        "AI briefing",
        "merged",
        "operational-brief",
        "Combine generated command context with other live signals.",
      ),
      entry(
        "Event radar",
        "merged",
        "operational-brief",
        "Treat event change as part of the same brief.",
      ),
      entry(
        "Threat heatmap",
        "merged",
        "operational-brief",
        "Threat posture supports the brief.",
      ),
      entry(
        "World event map",
        "merged",
        "operational-brief",
        "Map view becomes supporting evidence to the brief.",
      ),
      entry(
        "Business builder",
        "merged",
        "programs-workflows",
        "Business planning joins the program lane.",
      ),
      entry(
        "Job risk analyzer",
        "merged",
        "programs-workflows",
        "Keep program design and workflow evaluation close.",
      ),
      entry(
        "Workflow ops",
        "merged",
        "programs-workflows",
        "Workflow orchestration stays in the execution lane.",
      ),
      entry(
        "Vector snapshot",
        "demoted",
        "operational-brief",
        "Snapshot copy becomes supporting brief context.",
      ),
      entry(
        "Focus panel",
        "demoted",
        "programs-workflows",
        "Contextual focus belongs inside the active program state.",
      ),
      entry(
        "Project stack context",
        "merged",
        "context-memory",
        "Technical context belongs with memory and prior work.",
      ),
      entry(
        "Memory spine",
        "merged",
        "context-memory",
        "Memory becomes one continuity lane.",
      ),
      entry(
        "Ask memory",
        "merged",
        "context-memory",
        "Memory recall is part of the same continuity lane.",
      ),
    ],
  },
  intel: {
    ...
    boxMatrix: [
      entry(
        ...
        "merged",
        "news-brief",
        "Heatmaps belong under the first-view change brief.",
      ),
      entry(
        "Conflict feed",
        "merged",
        "news-brief",
        "Conflict feed is part of what changed.",
      ),
      entry(
        "World risk map",
        "merged",
        "theater-posture",
        "World maps become theater evidence.",
      ),
      entry(
        "Conflict impact assessment",
        "merged",
        "theater-posture",
        "Impact assessment belongs under theater posture.",
      ),
      entry(
        "Market rates",
        "merged",
        "cross-domain-impact",
        "Rates show cross-domain effect, not a separate peer box.",
      ),
      entry(
        "Live operations map",
        "merged",
        "cross-domain-impact",
        "Operations overlays support impact context.",
      ),
      entry(
        "Alpha Earth",
        "merged",
        "cross-domain-impact",
        "Alpha Earth remains specialist evidence under impact.",
      ),
      entry(
        "Prediction markets",
        "merged",
        "forecast-posture",
        "Prediction instruments belong together.",
      ),
      entry(
        "Macro rate context",
        "merged",
        "forecast-posture",
        "Macro context stays in the same forecast lane.",
      ),
      entry(
        "Sweep engine",
        "primary",
        "sweep-workbench",
        "Keep sweeps as a primary workspace.",
      ),
    ],
  },
  alpha: {
    ...
    modules: [
      ...
      },
      {
        ...
        summary: "Keep signal engine output as the primary setup lane.",
        role: "workspace",
      },
      {
        id: "momentum",
    ...
    boxMatrix: [
      entry(
        ...
        "merged",
        "market-brief",
        "Watchlist context opens the market brief.",
      ),
      entry(
        "Sparklines",
        "merged",
        "market-brief",
        "Sparklines support the brief instead of living alone.",
      ),
      entry(
        "Signal engine",
        "primary",
        "setups",
        "Keep setup generation primary.",
      ),
      entry(
        "Momentum scanner",
        "merged",
        "momentum",
        "Momentum becomes supporting selection evidence.",
      ),
      entry(
        "Position sizer",
        "merged",
        "risk-plan",
        "Sizing becomes the explicit risk lane.",
      ),
      entry(
        "Price grid",
        "merged",
        "market-tape",
        "Use the tape as final verification.",
      ),
      entry(
        "Charts",
        "merged",
        "market-tape",
        "Charts belong with the tape confirmation lane.",
      ),
      entry(
        "Forecast lab",
        "demoted",
        "forecast-lab",
        "Keep baseline evaluation visible in the support rail, not on top of the tape.",
      ),
    ],
  },
  cyber: {
    ...
    boxMatrix: [
      entry(
        ...
        "merged",
        "threat-brief",
        "Triage becomes the core cyber brief.",
      ),
      entry(
        "Threat intelligence signals",
        "merged",
        "threat-brief",
        "Signals belong inside the same brief.",
      ),
      entry(
        "Severity matrix",
        "merged",
        "priority-grid",
        "Priority stays explicit, but not as a peer with all other boxes.",
      ),
      entry(
        "CVE feed",
        "merged",
        "evidence-feeds",
        "Feed lists support the brief.",
      ),
      entry(
        "OTX feed",
        "merged",
        "evidence-feeds",
        "Threat feed evidence belongs together.",
      ),
      entry(
        "CISA KEV",
        "merged",
        "evidence-feeds",
        "KEV is a supporting evidence stream.",
      ),
      entry(
        "Drone compliance check",
        "merged",
        "physical-ops",
        "Keep compliance accessible but secondary.",
      ),
    ],
  },
  recon: {
    ...
    boxMatrix: [
      entry(
        ...
        "OSINT becomes a collection mode.",
      ),
      entry(
        "Passive DNS",
        "merged",
        "collection-workbench",
        "Passive DNS becomes a collection mode.",
      ),
      entry(
        "HTTP headers audit",
        "merged",
        "collection-workbench",
        "Headers audit becomes a collection mode.",
      ),
      entry(
        "Metadata extractor",
        "merged",
        "collection-workbench",
        "Metadata becomes a collection mode.",
      ),
      entry(
        "Binary triage",
        "merged",
        "binary-analysis",
        "Binary triage stays a dedicated reverse-engineering lane.",
      ),
      entry(
        "OPSEC panel",
        "merged",
        "operator-safety",
        "Safety remains visible, but compact and contextual.",
      ),
    ],
  },
  vault: {
    ...
    boxMatrix: [
      entry(
        ...
        "merged",
        "memory-brief",
        "Memory readiness belongs in the top archive brief.",
      ),
      entry(
        "Stewardship",
        "merged",
        "memory-brief",
        "Stewardship becomes compact archive posture.",
      ),
      entry(
        "Offline readiness",
        "merged",
        "memory-brief",
        "Offline archive posture belongs in the same brief.",
      ),
      entry(
        "Ask memory",
        "merged",
      ...
      entry(
        ...
        "merged",
        "archive-workbench",
        "Archive navigation belongs in the active workbench.",
      ),
      entry(
        "Search",
        "merged",
        "archive-workbench",
        "Search is part of archive work, not a peer posture card.",
      ),
      entry(
        "Document intake",
        "merged",
        "archive-workbench",
        "Intake stays inside the same workbench.",
      ),
      entry(
        "Compiled pages",
        "merged",
        "durable-artifacts",
        "Compiled pages lead the durable artifact lane.",
      ),
      entry(
        "Saved articles",
        "merged",
        "durable-artifacts",
        "Saved articles belong with durable artifacts.",
      ),
      entry(
        "Export",
        "merged",
        "durable-artifacts",
        "Export becomes a continuation action in the durability lane.",
      ),
      entry(
        "Registry kits",
        "merged",
        "durable-artifacts",
        "Kits stay near durable outputs.",
      ),
      entry(
        "Graph focus",
        "merged",
        "relations",
        "Graph context belongs with the relations lane.",
      ),
      entry(
        "Vault librarian",
        "merged",
        "relations",
        "Librarian support is part of relations.",
      ),
      entry(
        "Knowledge Graph",
        "merged",
        "relations",
        "Graph remains the main relations workspace.",
      ),
    ],
  },
  resources: {
    ...
    boxMatrix: [
      entry(
        ...
        "merged",
        "how-this-helps",
        "Intro guidance folds into one orientation module.",
      ),
      entry(
        "Operator reminder",
        "merged",
        "how-this-helps",
        "Reminder copy belongs in the same orientation block.",
      ),
      entry(
        "Coverage snapshot",
        "merged",
        "how-this-helps",
        "Coverage counts support the same orientation block.",
      ),
      entry(
        "Resources workbench",
        "merged",
        "open-exact-session",
        "The workbench remains primary but reframed around four operator jobs.",
      ),
      entry(
        "Finder posture",
        "merged",
        "find-right-lane",
        "Finder posture becomes a job-led orientation block.",
      ),
      entry(
        "Session finder",
        "merged",
        "open-exact-session",
        "Finder output leads toward exact-session opening.",
      ),
      entry(
        "Developer field manual",
        "merged",
        "supporting-utilities",
        "Manual remains available as a supporting utility.",
      ),
      entry(
        "Source intelligence",
        "primary",
        "source-intelligence",
        "External idea intake becomes a native Resources chamber with guardrails and promotion state.",
      ),
      entry(
        "Playbook posture",
        "merged",
        "start-safely",
        "Playbook posture belongs with safe starts.",
      ),
      entry(
        "Engineering playbooks",
        "merged",
        "start-safely",
        "Playbooks stay in the safe-start lane.",
      ),
      entry(
        "Spec posture",
        "merged",
        "start-safely",
        "Spec posture belongs with safe starts.",
      ),
      entry(
        "Spec-driven development",
        "merged",
        "start-safely",
        "Specs stay in the safe-start lane.",
      ),
      entry(
        "Surface posture",
        "merged",
        "understand-system",
        "Surface guidance explains the system.",
      ),
      entry(
        "Surface capabilities",
        "merged",
        "understand-system",
        "Surface audits belong with system understanding.",
      ),
      entry(
        "System posture",
        "merged",
        "understand-system",
        "System posture stays in the understanding lane.",
      ),
      entry(
        "System design",
        "merged",
        "understand-system",
        "Architecture mapping belongs in the same lane.",
      ),
      entry(
        "Impact posture",
        "merged",
        "open-exact-session",
        "Impact is used to leave overview mode quickly.",
      ),
      entry(
        "Project impact",
        "merged",
        "open-exact-session",
        "Impact belongs in exact-session staging.",
      ),
      entry(
        "Massive win planning",
        "primary",
        "massive-win-plans",
        "Big fix/improvement/upgrade plans become a native Resources lane instead of loose chat intent.",
      ),
      entry(
        "Registry posture",
        "merged",
        "supporting-utilities",
        "Registry remains a supporting utility.",
      ),
      entry(
        "Registry console",
        "merged",
        "supporting-utilities",
        "Registry remains available without equal visual weight.",
      ),
      entry(
        "Registry kits",
        "merged",
        "supporting-utilities",
        "Kits stay in the supporting utilities lane.",
      ),
    ],
  },
};
...
> = {
  ...
  study: {
    ...
    panelDetail:
      "Tutor profiles, memory compartments, and compact study continuations",
    panelSummary:
  ...
  surfaces: {
    ...
    panelDetail:
      "Mission, strengths, subsections, posture, and upgrade priorities",
    panelSummary:
