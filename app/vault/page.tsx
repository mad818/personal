...
function toSavedArticleNode(article: Article): VaultItemMetadata {
  return {
    ...
    namespace: "user",
    sourceType: "clip",
    tldr: article.desc || article.title,
  };
}
...
export default function VaultPage() {
  ...
  }, [compiledPageNodes, compiledPageTexts, savedArticleNodes, savedArticleTexts]);
  ...
  return (
    <ShellPage
      width="wide"
      surface="vault"
      eyebrow="Reliquary archive"
      title="ARCHIVE"
      description="Local-first memory, compiled research, relation topology, and reusable export lanes now run as one archive system with quieter support rails."
      actions={
        <>
      ...
      <ShellStack>
          ...
          <div className="nexus-surface-route-strip__grid">
            <div className="nexus-surface-route-strip__cell">
              ...
              <span className="nexus-surface-route-strip__cellNote">
                Saved clips and compiled memory now sit inside one archive system.
              </span>
            </div>
            <div className="nexus-surface-route-strip__cell">
              ...
              <span className="nexus-surface-route-strip__cellNote">
                The route now prioritizes one workbench chamber plus one quieter support rail.
              </span>
            </div>
            <div className="nexus-surface-route-strip__cell">
              ...
              <span className="nexus-surface-route-strip__cellNote">
                Relation mode stays focused on visible topology instead of a wider card wall.
              </span>
            </div>
            <div className="nexus-surface-route-strip__cell">
              ...
              <span className="nexus-surface-route-strip__cellNote">
                Durable artifacts stay one chamber away even while archive intake is primary.
              </span>
            </div>
          </div>
        </SurfaceModuleCard>
        ...
        {focus === "vault-memory-project" ? (
          <SurfaceFocusStrip
            ...
            description="You landed on VAULT with project memory in focus so repo continuity, prior fixes, and local durable context show up before wider archive browsing."
          />
        ) : null}
        ...
        {focus === "vault-memory-research" ? (
          <SurfaceFocusStrip
            ...
            description="You landed on VAULT with research memory in focus so source-backed continuity stays visible before broader archive work."
          />
        ) : null}
        ...
        {focus === "vault-memory-study" ? (
          <SurfaceFocusStrip
            ...
            description="You landed on VAULT with study memory in focus so prior notes, checkpoints, and practice continuity show up first."
          />
        ) : null}
        ...
        {focus === "vault-memory-conversation" ? (
          <SurfaceFocusStrip
            ...
            description="You landed on VAULT with conversation memory in focus so prior assistant context stays close before widening into archive work."
          />
        ) : null}
        ...
        {focus === "vault-memory-general" ? (
          <SurfaceFocusStrip
            ...
            description="You landed on VAULT with the general memory compartment in focus so broad durable notes stay visible before narrowing further."
          />
        ) : null}
        ...
        {focus === "vault-stewardship" ? (
          <SurfaceFocusStrip
            ...
            description="You landed on VAULT with archive stewardship in focus so link health, route continuity, and repair posture appear before broader browsing."
          />
        ) : null}
        ...
        {focus === "vault-graph-focus" ? (
          <SurfaceFocusStrip
            ...
            description="You landed on VAULT with relation topology in focus so graph drill-down, orphan recovery, and linked evidence stay in the lead chamber."
          />
        ) : null}
        ...
        {focus === "vault-compiled-pages" ? (
          <SurfaceFocusStrip
            ...
            description="You landed on VAULT with compiled pages in focus so durable notes, repair filters, and promotion posture show up before archive intake."
          />
        ) : null}
        ...
        {focus === "vault-export-second-brain" ? (
          <SurfaceFocusStrip
            ...
            description="You landed on VAULT with the export lane in focus so reusable packages and durable outputs are visible before archive browsing."
          />
        ) : null}
          ...
          <div id="vault-archive" style={{ scrollMarginTop: "120px" }}>
            <div className="nexus-surface-chamber-shell">
              <div className="nexus-surface-chamber-shell__body">
                <div className="nexus-surface-chamber-shell__support">
                  <div id="vault-memory-brief" style={{ scrollMarginTop: "120px" }}>
                    <SurfaceModuleCard spec={memoryBriefSpec} tone="muted" compact>
                ...
                <div className="nexus-surface-chamber-shell__lead">
                  <SurfaceModuleCard spec={archiveWorkbenchSpec} tone="hero">
                    <div className="nexus-surface-subtabs">
                      <ShellSegmentedTabs
              ...
              <div className="nexus-surface-continuity-strip">
                <SurfaceModuleCard
                  spec={durableArtifactsSpec}
                  tone="muted"
                  className="nexus-motion-enter nexus-motion-enter--continuity"
                >
                  <SurfaceModuleSection
          ...
          <div id="vault-relations" style={{ scrollMarginTop: "120px" }}>
            <div className="nexus-surface-chamber-shell">
              <div className="nexus-surface-chamber-shell__body">
                <div className="nexus-surface-chamber-shell__support">
                  <SurfaceModuleCard spec={memoryBriefSpec} tone="muted" compact>
                    <div className="nexus-shell-copy nexus-shell-copy--compact">
                      Relation mode keeps the graph primary. Stewardship, memory continuity, and archived output remain one rail away instead of competing with the topology view.
                    </div>
                ...
                <div className="nexus-surface-chamber-shell__lead">
                  <SurfaceModuleCard spec={relationsSpec} tone="hero">
                    <SurfaceModuleSection
                      title="Knowledge graph"
                      detail="Inspect how clips, pages, and durable notes connect"
                    >
                        ...
                        <div className="nexus-surface-chamber-shell__lead">
                          <div
                            style={{
                              ...
                              background:
                                "linear-gradient(180deg, rgba(5, 8, 16, 0.98), rgba(9, 14, 24, 0.88))",
                              overflow: "hidden",
                            }}
                          >
                            <LazyVaultGraphView
            ...
            <div className="nexus-surface-chamber-shell">
              <div className="nexus-surface-chamber-shell__body">
                <div className="nexus-surface-chamber-shell__support">
                  <SurfaceModuleCard spec={memoryBriefSpec} tone="muted" compact>
                    <div className="nexus-shell-copy nexus-shell-copy--compact">
                      Publish mode is where durable notes get promoted, repaired, bundled, and exported. Stewardship stays visible here so export does not outrun archive health.
                    </div>
                    <div className="nexus-shell-actions">
                ...
                <div className="nexus-surface-chamber-shell__lead">
                  <SurfaceModuleCard spec={durableArtifactsSpec} tone="hero">
                    <SurfaceModuleSection
                      title="Compiled memory pages"
                      detail="Promote, repair, and reuse durable archive outputs"
                    >
                      <LazyCompiledMemoryPagesPanel />
                    </SurfaceModuleSection>
                  </SurfaceModuleCard>
