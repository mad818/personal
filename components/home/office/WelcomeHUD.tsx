...
export function WelcomeHUD() {
  ...
  const cards = [
    ...
    },
    {
      ...
      sub:   worldRisk > 70 ? 'HIGH' : worldRisk > 40 ? 'MEDIUM' : worldRisk > 0 ? 'LOW' : undefined,
    ...
    },
    {
      ...
      sub:   Object.keys(agentStats).length > 0
        ? `${Object.keys(agentStats).length} AGENTS` : undefined,
      color: '#00DDFF',
      icon:  '⚡',
    },
    {
  ...
  return (
    <div style={{ padding: '18px 18px', display: 'flex', flexDirection: 'column', gap: '12px' }}>

      {/* ── Title ── */}
      <div style={{ textAlign: 'center' }}>
        <div style={{
          fontSize: '16px', fontFamily: "'VT323', monospace",
          color: '#00FF66', letterSpacing: '4px', marginBottom: '4px',
        }}>
          ◈ NEXUS PRIME INTEL CORPS ◈
        </div>
        <div style={{
          fontSize: '10px', fontFamily: "'VT323', monospace",
          color: '#1A2040', letterSpacing: '3px',
        }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 'var(--space-2)' }}>
        {cards.map((card, i) => (
          <div key={i} style={{
            ...
            boxShadow: pulse ? `0 0 0 1px ${card.color}55, 0 0 24px rgba(0,221,255,.08)` : 'none',
            textAlign: 'center',
          }}>
            {/* Card label */}
            <div style={{
              ...
              color: '#304060', letterSpacing: '1px', marginBottom: '4px',
            }}>
            ...
            <div style={{
              fontSize: '16px',
              fontFamily: "'Inter', system-ui, -apple-system, Segoe UI, sans-serif",
              color: card.color, letterSpacing: '1px',
            }}>
              {card.value}
            </div>
            ...
            {card.sub && (
              <div style={{
                ...
                color: card.color + '88', letterSpacing: '1px', marginTop: '2px',
