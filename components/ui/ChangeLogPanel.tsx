...
const TYPE_STYLE: Record<ChangeEntry['type'], { color: string; label: string }> = {
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
        ...
        <span style={{
          ...
          color: t.color, letterSpacing: '1px', flexShrink: 0,
        }}>
          {t.label}
        </span>
        ...
        <span style={{
          ...
          color: '#00DDFF', flex: 1, minWidth: 0,
        ...
        {delta !== 0 && (
          <span style={{
            ...
            color: delta > 0 ? '#00FF6688' : '#ef444488', flexShrink: 0,
          }}>
            {delta > 0 ? `+${delta}` : delta}
          </span>
        )}
      ...
      <div style={{ display: 'flex', gap: '8px' }}>
        <span style={{ fontSize: '7px', color: '#304060', fontFamily: 'monospace' }}>
    ...
    <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{
              ...
              color: '#00DDFF', letterSpacing: '2px', flex: 1,
            }}>
              CHANGE LOG
            </span>
            <span style={{ fontSize: '9px', fontFamily: 'monospace', color: '#304060' }}>
      ...
      >
        <span style={{
          ...
          background: '#00DDFF', display: 'inline-block',
        }} />
        <span style={{
