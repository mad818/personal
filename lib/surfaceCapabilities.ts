...
export const SURFACE_CAPABILITIES: SurfaceCapability[] = [
  ...
  },
  {
    ...
    mission:
      "Use CYBER when the task is about vulnerability posture, feed correlation, or compliance/risk framing rather than raw reconnaissance or general security doctrine.",
    strongestAbilities: [
  ...
  },
  {
    ...
    subsections: [
      ...
      { label: "Impact", detail: "Local-only blast-radius helper for real files.", href: "/resources?view=impact" },
  ...
  },
  {
    ...
    route: "/security",
    category: "support",
    tagline: "Doctrine, AI-surface review, and physical monitoring",
    mission:
      "Use SECURITY when the work is about doctrine, hardening, or physical-ops posture rather than live vulnerability triage or target-led reconnaissance.",
    strongestAbilities: [
      "Separates doctrine from AI-surface risk and physical-ops monitoring instead of mixing them into one stream.",
    ...
    bestFor: [
      ...
      "Checking doctrine and AI-surface coverage gaps.",
      "Physical monitoring context that should stay distinct from cyber triage.",
    ],
    subsections: [
      { label: "Doctrine", detail: "Route, auth, input, config, and AI-surface coverage.", href: "/security?view=doctrine&focus=security-doctrine" },
    ...
    costPosture:
      "Mostly local doctrine and local monitoring posture. This route is about review and framing more than expensive connector dependence.",
    offlinePosture:
      "Doctrine remains useful offline; physical monitoring should be treated as retained state if live sensors are unavailable.",
    upgradePriorities: [
      "Tie doctrine cards more directly into playbooks and impact seeds.",
    ...
    upgradeActions: [
      { label: "Open doctrine", href: "/security?view=doctrine&focus=security-doctrine", detail: "Start with boundary and review doctrine before broader governance edits." },
      ...
      { label: "Open security audit", href: "/resources?view=playbooks&playbook=security-boundary-audit", detail: "Use the shared security workflow when doctrine needs implementation follow-through." },
    ],
    jumpActions: [
      { label: "Open SECURITY", href: "/security", detail: "Land on the security doctrine route." },
