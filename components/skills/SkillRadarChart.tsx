...
interface CustomTooltipProps {
  ...
  payload?: Array<{
    value: number;
    payload: { domain: string; value: number };
  }>;
}
...
function CustomTooltip({ active, payload }: CustomTooltipProps) {
  ...
  return (
    ...
    >
      <div style={{ ...TOOLTIP_STYLE.labelStyle, marginBottom: "6px" }}>
        {d.domain}
      </div>
  ...
  return (
    ...
    >
      ...
      <ResponsiveContainer width="100%" height={280}>
        ...
        >
          <PolarGrid stroke={CHART.border2} strokeDasharray="3 3" radialLines />
          <PolarAngleAxis
            dataKey="domain"
            tick={{
              fontSize: 10,
      ...
      >
        {SKILL_DATA.map((d) => (
          ...
          >
            ...
            <span
              style={{
                color: d.value >= 85 ? CHART.rose : CHART.gold,
                fontWeight: 700,
              }}
            >
              {d.value}%
