...
export function PMChecklist() {
  ...
  const categories: PMChecklistItem['category'][] = ['daily', 'pre-push', 'post-incident']
  ...
  return (
    <div style={{ marginTop: '18px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
        ...
        <span style={{
          fontSize: '10px', color: totalChecked === total ? 'var(--fhi)' : 'var(--text3)',
        ...
        <button
          ...
          style={{
            height: '22px', padding: '0 8px', borderRadius: '5px',
        ...
        return (
          <div key={cat} style={{ marginBottom: '12px' }}>
            <div style={{
              ...
              {CATEGORY_LABELS[cat]}
              <span style={{
                fontSize: '9px', color: catChecked === items.length ? 'var(--fhi)' : 'var(--text3)',
              }}>
