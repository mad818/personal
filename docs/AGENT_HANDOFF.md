...
- FREE-LOCAL-PHONE-ACCEPTANCE — Desktop LAN runtime proof and the phone checklist are in place, and the receipt lane now exists: the existing Free Local Readiness panel silently posts sanitized local receipts to protected...
