...
const SYNTHETIC_MARKETS: MarketEntry[] = [
  {
    question: "US inflation falls below 3% by Q3 2026",
    short: "Inflation < 3%",
    prob: 72,
  },
  {
    question: "Fed cuts rates at least once before June 2026",
    short: "Fed rate cut",
    prob: 64,
  },
  {
    question: "BTC exceeds $120k by end of 2026",
    short: "BTC > $120k",
    prob: 58,
  },
  {
    question: "AI regulation bill passes US Senate 2026",
    short: "AI Bill Senate",
    prob: 44,
  },
  {
    question: "SPX closes above 6500 by year-end 2026",
    short: "SPX > 6500",
    prob: 67,
  },
  {
    question: "Recession declared in any G7 country by 2027",
    short: "G7 Recession",
    prob: 38,
  },
  {
    question: "GPT-5 releases publicly before end of 2026",
    short: "GPT-5 release",
    prob: 82,
  },
  {
    question: "Climate tipping point event before 2030",
    short: "Climate Event",
    prob: 29,
  },
];
  ...
  return (
    <div style={{ ...TOOLTIP_STYLE.contentStyle, maxWidth: "220px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
        <div
          style={{ width: 8, height: 8, borderRadius: "2px", background: c }}
        />
          ...
          <Bar dataKey="prob" radius={[0, 4, 4, 0]}>
            {sorted.map((entry, i) => (
              <Cell
                ...
                fillOpacity={0.8}
                style={{
                  filter: `drop-shadow(0 0 4px ${getProbColor(entry.prob)}44)`,
                }}
              />
            ))}
            <LabelList
