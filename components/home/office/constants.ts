...
> = {
  normal: {
    ...
    promptPrefix:
      "[Operational Profile: Focus/Normal] Balanced execution. Keep updates concise.",
  },
  war: {
    label: "WAR ROOM",
    focusTabs: ["cyber", "ops"],
    ...
    noisySuccessAlerts: true,
    promptPrefix:
      "[Operational Profile: War Room] Prioritize active threat monitoring and rapid incident context.",
  },
  nightOps: {
    label: "NIGHT OPS",
    ...
    promptPrefix:
      "[Operational Profile: Night Ops] Low-noise monitoring. Surface anomalies and high-risk changes only.",
  },
};
