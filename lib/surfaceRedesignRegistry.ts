...
> = {
  hq: {
    ...
    modules: [
      {
        ...
        summary:
          "Combine doctrine, posture, mission codex, and strategic pressure into one top-level command brief.",
        role: "brief",
        strongestAction: {
          label: "Prime the mission",
          note: "Lead with the active doctrine and the codex action that matters most right now.",
        },
      },
      {
        id: "next-move",
    ...
    boxMatrix: [
      entry("Operational Litany", "merged", "mission-brief", "Merge doctrine and mode emphasis into the main brief."),
