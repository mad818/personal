...
const LEVELS: { id: ThreatLevel; color: string; bg: string; desc: string }[] = [
  {
    ...
    color: CHART.emerald,
    bg: "#052e1c",
    desc: "Minimal threat activity detected",
  },
  {
    id: "GUARDED",
    color: CHART.teal,
    bg: "#062028",
    desc: "General threat conditions apply",
  },
  {
    id: "ELEVATED",
    color: CHART.gold,
    bg: "#2a1a04",
    desc: "Significant threat environment",
  },
  {
    id: "HIGH",
    color: CHART.orange,
    bg: "#2a0e04",
    desc: "High risk of hostile activity",
  },
  {
    id: "SEVERE",
    color: CHART.red,
    bg: "#2a0404",
    desc: "Severe risk — imminent threat",
  },
];
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          <div
            style={{ fontSize: "11px", color: CHART.text2, marginTop: "3px" }}
          >
            {level.desc}
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                <span
                  style={{
                    fontSize: "7px",
                    color: active ? l.color : CHART.text3,
                    fontFamily: "monospace",
