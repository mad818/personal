      ...
      {open && (
        <div
          ...
          style={{
            ...
            animation: "worldFadeIn .15s ease",
          }}
        />
      )}
      <div
      ...
      >
        ...
        >
          {articles.map((a) => {
            ...
            const sentLabel =
              score > 0.1 ? "Stable" : score < -0.1 ? "Hostile" : "Neutral";
            return (
              <div
                key={a.id}
                style={{
...
function HeatCell({
  ...
  const avgScore =
    count === 0
      ? 0
      : articles.reduce(
          (sum, a) => sum + sentimentScore(a.title + " " + (a.desc ?? "")),
          0,
        ) / count;
  const sentColor =
    avgScore > 0.1 ? "#10b981" : avgScore < -0.1 ? "#ef4444" : "#6875a0";
  const sentLabel =
    avgScore > 0.1 ? "Stable" : avgScore < -0.1 ? "Hostile" : "Neutral";
