...
- FREE-LOCAL-PHONE-ACCEPTANCE — Desktop LAN runtime proof is captured: `npm run phone:lan:start` printed `http://192.168.68.74:3100` and `http://192.168.68.74:3100/hq?focus=hq-chronicle`, while raw desktop checks returned 200 for `/api/health`,...
